...
import OpenAiKeySetupModal from "../components/OpenAiKeySetupModalNext";
import { resolveOpenAiAccountLabel } from "../utils/openAiKeySetup";

const API_URL = (import.meta.env.VITE_API_URL || "https://wa.waflow.com").replace(/\/$/, "");
const inputClassName = "w-full rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm outline-none focus:ring-2 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white";
const textAreaCardClassName = "w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-sm outline-none focus:ring-2 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white";
...
export default function WorkflowAgentsPanel({ locations = [], onUnauthorized, token, onOpenSettings }) {
    ...
    const renderAgentList = (isEditorMode = false) => (
        <section className={`${isEditorMode ? "xl:sticky xl:top-6" : ""} bg-white px-1 py-2 dark:bg-gray-900`}>
            <div className="mt-4 space-y-2">
                {filteredAgents.length === 0 ? (
                    <div className="rounded-2xl bg-gray-50/70 px-4 py-8 text-center text-sm text-gray-500 dark:bg-gray-950/40 dark:text-gray-400">
                ...
                {filteredAgents.map((agent) => {
                    ...
                    <div
                        key={agent.id}
                        className={`group flex w-full flex-col items-stretch gap-4 rounded-[22px] bg-gray-50/70 px-4 py-4 text-left transition hover:bg-gray-50 sm:flex-row dark:bg-gray-950/35 dark:hover:bg-gray-900/70 ${
                            isEditorMode && editingAgentId === agent.id
                                ? "bg-indigo-50/80 shadow-sm ring-1 ring-indigo-200 dark:bg-indigo-900/20 dark:ring-indigo-700/40"
                                : ""
                        }`}
                    >
                        <button
                        ...
                        >
                            <span className={`mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl ${
                                isActive
                        ...
                        <div className="flex w-full shrink-0 flex-col justify-between gap-2 p-1 sm:w-[150px] sm:items-end">
                            <button
                                type="button"
                                role="switch"
                                ...
                                className={`inline-flex w-full items-center justify-center gap-2 rounded-full px-2.5 py-2 text-[11px] font-bold transition disabled:cursor-not-allowed disabled:opacity-60 ${
                                    isActive
                            ...
                            <button
                                ...
                                className={`rounded-full px-3 py-2 text-[11px] font-bold transition disabled:cursor-not-allowed disabled:opacity-50 ${
                                    isDefaultReady
    ...
    const renderChatPanel = () => (
        <section className="w-full overflow-hidden rounded-[24px] bg-gray-50/70 dark:bg-gray-950/40">
            <div className="flex items-start justify-between gap-3 px-4 py-4">
                ...
                <div className="flex flex-wrap items-center justify-end gap-2">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-2xl bg-white px-3 py-2 text-xs font-semibold text-gray-600 transition hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
                    >
            ...
            <div className="space-y-4 p-4">
                    <div className="wf-soft-scrollbar min-h-[240px] max-h-[42vh] space-y-3.5 overflow-auto pr-1">
                        ...
                        {testResult ? (
                            ...
                            <div className="flex h-[200px] items-center justify-center rounded-[22px] bg-gray-50 px-5 text-center text-sm leading-6 text-gray-500 dark:bg-gray-800/60 dark:text-gray-400">
    ...
    const renderAgentCreationDialog = () => {
        ...
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/70 px-4 py-6 backdrop-blur-sm">
                <div className="w-full max-w-4xl overflow-hidden rounded-[30px] bg-white shadow-2xl dark:bg-gray-950">
                    <div className="flex items-start justify-between gap-4 px-5 py-5 sm:px-7">
                            ...
                            <div className="flex min-w-0 items-center gap-3">
                                {isPresetMode ? (
                                    <button
                                        ...
                                        className="inline-flex shrink-0 items-center gap-1.5 rounded-xl px-2 py-2 text-sm font-semibold text-gray-500 transition hover:bg-gray-50 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-gray-900 dark:hover:text-gray-200"
                                        aria-label={t("workflow_agents.preset_modal_back")}
                                    >
                                        <ChevronLeft size={17} />
                                        <span className="hidden sm:inline">{t("workflow_agents.preset_modal_back")}</span>
                                    </button>
                                ) : null}
                        ...
                        <button
                            ...
                            className="rounded-xl px-2 py-2 text-sm font-bold text-gray-400 transition hover:bg-gray-50 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-gray-200"
                        >
                    ...
                    {isPresetMode ? (
                                ...
                                <div className="grid gap-2 md:grid-cols-2 xl:grid-cols-3">
                                    {filteredAgentPresets.map((preset) => (
                                        <button
                                            ...
                                            className="group flex min-h-[170px] flex-col rounded-[22px] bg-gray-50/70 p-5 text-left transition hover:bg-gray-100 dark:bg-gray-900/70 dark:hover:bg-gray-900"
                                        >
                                            ...
                                            <div className="mt-4 text-sm font-bold text-indigo-600 dark:text-indigo-300">
                        ...
                        <div className="grid gap-2 px-5 pb-6 sm:px-7 md:grid-cols-2">
                            <button
                                type="button"
                                onClick={startBlankAgent}
                                className="group rounded-[22px] bg-gray-50/70 p-5 text-left transition hover:bg-gray-100 dark:bg-gray-900/70 dark:hover:bg-gray-900"
                            >
    ...
    return (
        <div className="wf-agents-ui mx-auto max-w-7xl space-y-4">
            ...
            {viewMode === "list" ? (
                <div className="flex flex-col gap-3 xl:flex-row xl:items-end">
                    <button
                        type="button"
                        onClick={openAgentCreationDialog}
                        className="flex h-[44px] w-full shrink-0 items-center justify-center rounded-xl bg-indigo-600 px-3.5 text-sm font-semibold text-white transition hover:bg-indigo-500 xl:w-auto"
                    >
                        {t("workflow_agents.new_agent")}
                    </button>
                    ...
                    <div className="w-full xl:max-w-[320px]">
                        <label className="mb-1.5 block text-xs font-semibold text-gray-500 dark:text-gray-400">{t("workflow_agents.location_label")}</label>
                        <select
                            ...
                            className={`${inputClassName} h-[44px] py-0 bg-white dark:bg-gray-900`}
                        >
            ...
            {viewMode === "list" ? (
                ...
                <div className="space-y-6">
                    <section className="overflow-hidden rounded-[30px] bg-white dark:bg-gray-900">
                    <div className="flex flex-col gap-3 px-1 py-2 lg:flex-row lg:items-start lg:justify-between">
                        <div className="min-w-0">
                    ...
                    <div className="px-1 py-3">
                        <div className="inline-flex max-w-full flex-wrap gap-1 rounded-2xl bg-gray-50/80 p-1 dark:bg-gray-800/60">
                            <TabButton active={activeTab === "general"} label={t("workflow_agents.tab_general")} onClick={() => setActiveTab("general")} />
                            <TabButton active={activeTab === "behavior"} label={t("workflow_agents.section_behavior_title")} onClick={() => setActiveTab("behavior")} />
                            <TabButton active={activeTab === "actions"} label={t("workflow_agents.section_permissions_title")} onClick={() => setActiveTab("actions")} />
                    ...
                    <div className="p-4 sm:p-5">
                        {activeTab === "test" ? renderChatPanel() : null}
                        {activeTab !== "documents" && activeTab !== "test" && (
                            <form onSubmit={handleSave} className="space-y-5">
                                ...
                                <>
                                    <EditorSection title={t("workflow_agents.section_permissions_title")} description={t("workflow_agents.section_permissions_desc")}>
                                            ...
                                            {actionPermissionItems.map(([permissionKey, labelText, descText, actionKind]) => {
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`${isTagAction ? "cursor-pointer" : ""} rounded-2xl px-4 py-4 transition ${
                                                            enabled
                                                                ? "bg-indigo-50/80 dark:bg-indigo-900/20"
                                                                : "bg-gray-50/70 hover:bg-gray-100 dark:bg-gray-950/40 dark:hover:bg-gray-900"
                                                        }`}
                                                    >
                                                    ...
                                                    enabled ? (
                                                        <div className="mt-4 flex flex-wrap gap-2">
                                                            <button
                                                                ...
                                                                className="rounded-2xl bg-gray-100 px-3 py-2 text-xs font-bold text-gray-500 transition hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                                                            >
                                                            ...
                                                            <button
                                                                ...
                                                                className="mt-4 rounded-2xl bg-gray-100 px-3 py-2 text-xs font-bold text-gray-600 transition hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
                                                            >
                                        ...
                                        {form.calendar_scope_mode === "selected" ? (
                                            <div className="mt-4 rounded-2xl bg-gray-50/70 p-4 dark:bg-gray-950/40">
                                                {calendarsCatalog.length === 0 ? (
                                                    ...
                                                    <div className="grid gap-3 lg:grid-cols-2">
                                                        {calendarsCatalog.map((calendar) => {
                                                            ...
                                                            return (
                                                                <label key={calendarValue} className="flex items-center gap-3 rounded-2xl bg-white px-4 py-3 text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-200">
                                                                    <input
                                                                        type="checkbox"
                                                                        checked={isChecked}
                                                                        onChange={(event) => setForm((prev) => ({
                                ...
                                <div className="space-y-3 rounded-[26px] bg-gray-50/70 px-5 py-4 dark:bg-gray-950/40">
