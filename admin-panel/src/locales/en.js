export const en = {
    ...
    "agency.onboarding.selfhosted_account": "Account hosted by us",
    "agency.onboarding.chatwoot_selfhosted_form": "We create and manage your Chatwoot account",
    "agency.onboarding.chatwoot_master_missing": "For hosted-by-us accounts, configure the Chatwoot Master User first.",
    ...
    "agency.onboarding.chatwoot_master_step_desc": "This user is reused to provision new Chatwoot accounts hosted by us.",
    ...
    "agency.onboarding.ghl_verification_required": "Complete and verify email and phone before creating the sub-account.",
    ...
    "agency.onboarding.ghl_verification_disabled_hint": "Test mode active: email and phone verification is disabled for sub-account creation.",
    ...
    "agency.onboarding.install_app_prompt": "Do you want to install the Waflow app in the new sub-account now?",
    "agency.onboarding.ghl_subaccount_request_hint": "Complete the form and our team will contact you within 24 to 48 hours to create the sub-account.",
    "agency.onboarding.ghl_subaccount_notes": "Additional notes",
    "agency.onboarding.ghl_subaccount_notes_placeholder": "Tell us if you need a domain, niche, country, or any useful detail to prepare the sub-account.",
